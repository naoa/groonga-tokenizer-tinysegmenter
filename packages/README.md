...
cd /usr/local/src/groonga-tokenizer-tinysegmenter
make clean
sh clean.sh
sh autogen.sh
./configure && make
...
cp packages/rpm/centos/groonga-tokenizer-tinysegmenter.spec ~/rpmbuild/SPECS/

cd /usr/local/src
rm -rf groonga-tokenizer-tinysegmenter-1.0.0
cp -rf groonga-tokenizer-tinysegmenter groonga-tokenizer-tinysegmenter-1.0.0
tar zcvf groonga-tokenizer-tinysegmenter-1.0.0.tar.gz groonga-tokenizer-tinysegmenter-1.0.0
mv groonga-tokenizer-tinysegmenter-1.0.0.tar.gz ~/rpmbuild/SOURCES/
rpmbuild -ba ~/rpmbuild/SPECS/groonga-tokenizer-tinysegmenter.spec
mv ~/rpmbuild/RPMS/x86_64/groonga-tokenizer-tinysegmenter-1.0.0-1.el6.x86_64.rpm /usr/local/src/groonga-tokenizer-tinysegmenter/public/centos/6/
```
...
…
mv ~/rpmbuild/RPMS/x86_64/groonga-tokenizer-tinysegmenter-1.0.0-1.el7.centos.x86_64.rpm /usr/local/src/groonga-tokenizer-tinysegmenter/public/centos/7/```
```
...
yum install -y groonga-devel autoconf automake libtool wget tar gcc-c++ make mecab-devel libedit-devel rpm-build rpmdevtools
…
cp packages/rpm/fedora/groonga-tokenizer-tinysegmenter.spec ~/rpmbuild/SPECS/
…
mv ~/rpmbuild/RPMS/x86_64/groonga-tokenizer-tinysegmenter-1.0.0-1.fc20.x86_64.rpm /usr/local/src/groonga-tokenizer-tinysegmenter/public/fedora/20/
```
...
cp -rf groonga-tokenizer-tinysegmenter groonga-tokenizer-tinysegmenter-1.0.0
tar zcvf groonga-tokenizer-tinysegmenter-1.0.0.tar.gz groonga-tokenizer-tinysegmenter-1.0.0
mv groonga-tokenizer-tinysegmenter-1.0.0.tar.gz ~/build/groonga-tokenizer-tinysegmenter_1.0.0.orig.tar.gz
cd ~/build
tar xfz groonga-tokenizer-tinysegmenter_1.0.0.orig.tar.gz
cd groonga-tokenizer-tinysegmenter-1.0.0/
cp -rf packages/debian .
debuild -us -uc -b
cd ..
mv ~/build/groonga-tokenizer-tinysegmenter_1.0.0-1_amd64.deb /usr/local/src/groonga-tokenizer-tinysegmenter/public/debian/wheezy/
```
...
…
mv ~/build/groonga-tokenizer-tinysegmenter_1.0.0-1_amd64.deb /usr/local/src/groonga-tokenizer-tinysegmenter/public/debian/jessie/
```
...
…
mv ~/build/groonga-tokenizer-tinysegmenter_1.0.0-1_amd64.deb /usr/local/src/groonga-tokenizer-tinysegmenter/public/ubuntu/precise/
```
...
…
mv ~/build/groonga-tokenizer-tinysegmenter_1.0.0-1_amd64.deb /usr/local/src/groonga-tokenizer-tinysegmenter/public/ubuntu/trusty/
```
